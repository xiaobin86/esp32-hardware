...
draw.text((W//2 - 200, 80), "Standard 8-Pin Version", fill=C_WARN, font=font_small)
...
draw.text((gy91_x + 80, gy91_y + 58), "Standard 8-Pin", fill=C_WARN, font=font_small)

# Chip labels
draw.rounded_rectangle([gy91_x + 30, gy91_y + 85, gy91_x + 140, gy91_y + 115], 
                        radius=5, fill='#2d2d2d', outline='#e94560', width=2)
draw.text((gy91_x + 45, gy91_y + 93), "MPU9250", fill='#e94560', font=font_pin)

draw.rounded_rectangle([gy91_x + 170, gy91_y + 85, gy91_x + 280, gy91_y + 115], 
                        radius=5, fill='#2d2d2d', outline='#51cf66', width=2)
draw.text((gy91_x + 190, gy91_y + 93), "BMP280", fill='#51cf66', font=font_pin)

# GY-91 8-Pin Version Pins
gy91_pins = [
...
# ============= PIN DESCRIPTION =============
desc_x, desc_y = 60, H - 110
draw.rounded_rectangle([desc_x, desc_y, desc_x + 1100, desc_y + 80], 
                        radius=8, fill='#0f3460', outline='#533483', width=2)
draw.text((desc_x + 15, desc_y + 10), "GY-91 Pin Notes (8-Pin Standard Version)", fill=C_TITLE, font=font_header)
draw.text((desc_x + 20, desc_y + 35), "• SAO/SDO is a shared pin: controls I2C address for BOTH MPU9250 and BMP280 simultaneously", fill=C_LABEL, font=font_small)
draw.text((desc_x + 20, desc_y + 55), "• 3V3 is OUTPUT only (onboard LDO), do NOT connect to ESP32 power pin", fill=C_LABEL, font=font_small)
